...
export default class Swiper extends Component {
    ...
    return (
      ...
      >
        {pages.map((page, i) =>
          ...
          <View style={[{height: this.props.height, width: this.props.width}, styles.slide]} key={i}>
            {page}
          </View>
        )}
      </ScrollView>
  ...
  renderPagination = () => {
    if(this.props.pagination){
      ...
      return (
        <View
          pointerEvents="none"
          style={[styles.pagination, {height: this.props.height, width: this.props.width}]}
        >
          {dots}
        </View>
      );
  ...
  renderButton = () => {
    if(this.props.buttons){
      ...
      return (
        <View pointerEvents="box-none" style={[styles.buttonWrapper, {height: this.props.height, width: this.props.width}]}>
          {lastScreen
            // Show this button on the last screen
            // TODO: Add a handler that would send a user to your app after onboarding is complete
            ? <Button text="Start Now" onPress={() => this.props.exit()}/>
